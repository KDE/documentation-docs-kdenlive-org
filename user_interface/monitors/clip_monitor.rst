...
.. list-table::
   ...
   * - Go to Previous Guide
     - :kbd:`Ctrl+Left`
     - Goes to the previous :term:`marker<markers>` or :term:`Timeline Marker (former Guide)`
   ...
   * - Go to Next Guide
     - :kbd:`Ctrl+Right`
     - Goes to the next :term:`marker<markers>` or :term:`Timeline Marker (former Guide)`
   * - Go to Project End
     - :kbd:`Ctrl+End`
