.. meta::
   :description: Kdenlive Documentation - Welcome and Splash Screen
   :keywords: KDE, Kdenlive, use, using, welcome screen, splash screen, documentation, user manual, video editor, open source, free, learn, easy
