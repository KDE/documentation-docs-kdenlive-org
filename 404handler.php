...
$redirect_rules = array(
    ...
    "^effect_link\/avfilter.grayworld" => "effects_and_filters/video_effects/misc/grayworld.html",
    "^effect_link\/avfilter.huesaturation" => "effects_and_filters/video_effects/misc/huesaturation.html",
    "^effect_link\/avfilter.hsvkey" => "effects_and_filters/video_effects/misc/hsvkey.html",
    "^effect_link\/deinterlace" => "effects_and_filters/video_effects/misc/xine_deinterlacer.html",
    "^effect_link\/frei0r.pixs0r" => "effects_and_filters/video_effects/misc/pixs0r.html",
    "^effect_link\/gpsgraphic" => "effects_and_filters/video_effects/misc/gps_graphic.html",
    "^effect_link\/avfilter.scharr" => "effects_and_filters/video_effects/misc/scharr.html",
    "^effect_link\/frei0r.denoise_hqdn3d" => "effects_and_filters/video_effects/misc/hqdn3d.html",
    "^effect_link\/frei0r.kaleid0sc0pe" => "effects_and_filters/video_effects/misc/kaleid0sc0pe.html",
    "^effect_link\/avfilter.backgroundkey" => "effects_and_filters/video_effects/misc/backgroundkey.html",
    "^effect_link\/avfilter.alphaextract" => "effects_and_filters/video_effects/misc/alphaextract.html",
    "^effect_link\/avfilter.hsvhold" => "effects_and_filters/video_effects/misc/hsvhold.html",
    ...
    "^effect_link\/avfilter.elbg" => "effects_and_filters/video_effects/stylize/elbg_posterizer.html",
    ...
    "^effect_link\/frei0r.glitch0r" => "effects_and_filters/video_effects/motion/glitch0r.html",
    ...
    "^transition_link\/frei0r.sleid0r_push-down" => "compositing/transitions/transitions_list.html#push-down_up",
    "^transition_link\/frei0r.sleid0r_push-up" => "compositing/transitions/transitions_list.html#push-down_up",
    "^transition_link\/frei0r.sleid0r_push-left" => "compositing/transitions/transitions_list.html#push-left_right",
    "^transition_link\/frei0r.sleid0r_push-right" => "compositing/transitions/transitions_list.html#push-left_right",
    ...
    "^transition_link\/frei0r.sleid0r_slide-down" => "compositing/transitions/transitions_list.html#slide-down_up",
    "^transition_link\/frei0r.sleid0r_slide-up" => "compositing/transitions/transitions_list.html#slide-down_up",
    "^transition_link\/frei0r.sleid0r_slide-left" => "compositing/transitions/transitions_list.html#slide-left_right",
    "^transition_link\/frei0r.sleid0r_slide-right" => "compositing/transitions/transitions_list.html#slide-left_right",
    ...
    "^transition_link\/frei0r.addition" => "compositing/compositions/blend_modes.html#addition_addition-alpha",
    "^transition_link\/frei0r.addition_alpha" => "compositing/compositions/blend_modes.html#addition_addition-alpha",
