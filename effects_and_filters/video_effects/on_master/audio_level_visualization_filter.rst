...
This effect/filter is an audio visualization effect that draws an audio level meter on the image. It can be :ref:`direct controlled on the monitor <ui-monitors_effect_direct_control>`.
