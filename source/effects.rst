...
To export the keyframes the clipboard click on 

.. image:: /images/icons/application-menu.svg

inside the keyframe widget and choose :menuselection:`Copy keyframes to clipboard`
...
To import keyframes from the clipboard click on 

.. image:: /images/icons/application-menu.svg

inside the keyframe widget and choose :menuselection:`Import keyframes from clipboard`. If you have valid data on your clipboard you should see a dialog similar to the screenshot where you can adjust the mapping of the data.
