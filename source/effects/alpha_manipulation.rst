...
For some background, the Wikipedia article in `alpha compositing <http://en.wikipedia.org/wiki/Alpha_compositing>`_ is useful. See also Porter, Thomas; Tom Duff (1984). "Compositing Digital Images". Computer Graphics 18 (3): p253–259 1984 `pdf <http://keithp.com/~keithp/porterduff/p253-porter.pdf>`_
