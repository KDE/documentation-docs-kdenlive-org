...
:9: :guilabel:`Allowed FFmpeg parameters for proxy clips`. It shows a list of all parameters which FFmpeg allows. If a profile with an unexpected parameter is created or imported, Kdenlive shows a warning and asks the user if he really wants to allow these parameters.
