...
.. .. versionadded:: 22.12 Disable countdown before recording
...
:6: :guilabel:`Sample format`. Try one of these options if recording is not working properly. Options are **8bit** , **16bit**, **32bit**, and **float**.
