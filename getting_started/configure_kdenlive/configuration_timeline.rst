...
.. figure:: /images/getting_started/configure_timeline_2604.webp
   :width: 700px
   :figwidth: 700px
...
:8: :guilabel:`Fixed centered playhead`. If checked, the playhead remains locked at the center of the timeline while the timeline content scrolls beneath it during playback, scrubbing, and seeking.

:9: :guilabel:`Scroll vertically with mouse wheel (MW), horizontally with Shift+MW`. Changes the default behavior of the mouse wheel (MW) in the timeline.

:10: :guilabel:`Display clip markers comments`. If checked, comments added to markers are displayed.
