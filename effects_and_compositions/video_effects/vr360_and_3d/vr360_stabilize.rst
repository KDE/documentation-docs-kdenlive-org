...
#. Apply the :doc:`/effects_and_compositions/video_effects/vr360_and_3d/vr360_hemi2equi` effect to it so it is in equirectangular format

#. Apply the :doc:`/effects_and_compositions/video_effects/vr360_and_3d/vr360_transform` effect
...
#. Use the :doc:`/effects_and_compositions/video_effects/vr360_and_3d/vr360_transform` effect to rotate the footage so that the point straight ahead is over the center cluster of track points
