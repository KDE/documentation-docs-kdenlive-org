...
.. note::
   This effect works similar to the :doc:`/effects_and_compositions/video_effects/color_image_correction/color_overlay` effect but produces slightly different results for crispiness and detail.
