...
This effect/filter applies the Kirsch\ [1]_ operator to the input video stream. It detects edges (non-linear edge detector) and, in the default settings, colors them in yellowish green, and colors are somewhat posterized. Compare :doc:`/effects_and_compositions/video_effects/stylize/prewitt`, :doc:`/effects_and_compositions/video_effects/stylize/roberts` and :doc:`/effects_and_compositions/video_effects/stylize/sobel` effects.
