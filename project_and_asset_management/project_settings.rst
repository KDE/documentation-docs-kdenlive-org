...
Here you also define the categories and colors for the guides you can use in the timeline to structure your project.

Once the project is underway, you can find here some statistics about your project, like number and size of the clips, and used vs unused, and about the data cache. Kdenlive gives you full control over the use and utilization of your assets.

The project settings dialog is opened every time a new project is created (:menuselection:`File --> New`), or via the menu :menuselection:`Project --> Project Settings`.