.. meta::
   :description: Kdenlive Documentation - File Management
   :keywords: KDE, Kdenlive, project bin, working, file, management, documentation, user manual, video editor, open source, free, learn, easy
...
.. toctree:: 
   ...
   file_management/auto_save
   file_management/backup
   file_management/archiving
