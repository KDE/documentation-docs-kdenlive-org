...
.. Open a link in a new tab in reStructuredText (attribute target="_blank")
...
Web page link open in a new tab |kde| 

.. |kde| raw:: html

   <a href="https://www.kde.org" target="_blank">KDE</a>

Web page link open in the same window `KDE store <https://store.kde.org/browse?cat=333&amp;ord=latest>`__
