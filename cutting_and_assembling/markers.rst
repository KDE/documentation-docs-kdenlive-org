...
* **Menu**
  ...
  * Clip monitor: From the main menu choose :menuselection:`Clip --> Marker --> Add Marker`
  * Timeline: Click on the clip. From the main menu choose :menuselection:`Clip --> Marker --> Add Marker`
